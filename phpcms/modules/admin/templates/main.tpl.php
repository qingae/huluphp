...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?> xxxcms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://download.phpcms.cn/v9/" target="_blank"><?php echo L('main_latest_version')?></a>]<br />
...
<div class="bk10"></div>
<div class="col-2 lf mr10" style="width:48%">
	<h6><!--<?php echo L('main_product_team')?>-->public message </h6>
	<div class="content">
	<!--
