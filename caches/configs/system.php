...
'cookie_pre' => 'VBuFE_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
//附件相关配置
'upload_path' => PHPCMS_PATH.'myuploadfile/',
'upload_url' => 'http://'.$domain.'/myuploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://'.$domain.'/mystatics/js/', //CDN JS
'css_path' => 'http://'.$domain.'/mystatics/css/', //CDN CSS
'img_path' => 'http://'.$domain.'/mystatics/images/', //CDN img
'app_path' => 'http://'.$domain.'/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'fp0y5PaHuYd4VCkdzu0g', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '0',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://'.$domain.'/cms/phpsso_server',	//接口地址
'phpsso_auth_key' => '0b9rVcA2dpZmaxQVMmL2494nXgfWk6ai', //加密密钥
